...
export default function WatchlistButton({ anime }: { anime: AnimeCardData }) {
  ...
  return (
    <motion.button 
      ...
      whileTap={{ scale: 0.95 }}
      className={`flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-3 rounded-full font-bold text-sm shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-colors ${
        saved 
