    ...
    <div className="flex flex-col lg:flex-row gap-6 w-full pb-10 max-w-[1600px] mx-auto">
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="glass-card p-6 md:p-8 rounded-2xl flex flex-col gap-5 border border-white/5 mt-2">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-black text-white tracking-tighter shadow-sm mb-3">{anime?.info.judul || episode.title}</h1>
          ...
          {anime?.synopsis && (
            <p className="text-sm text-zinc-400 leading-relaxed text-justify mt-2 max-w-4xl line-clamp-5">
              {anime.synopsis}
            </p>
          )}
